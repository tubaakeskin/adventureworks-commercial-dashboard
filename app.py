...
# ==============================================================================
# 2. SMART DATA LOADING WITH CLEAN PIPELINES
# ==============================================================================
@st.cache_data
def load_and_merge_data():
    ...
    # 5. Build Robust Returns Structure
...
if page == "📊 Executive Summary":
    ...
    with diag_col1:
        st.info(f"💡 **Pipeline Live:** Schema types and logic blocks successfully parsed. Dynamic tracking active for fiscal segment FY{selected_year}.")
    with diag_col2:
        if return_rate > 3.0:
...
st.markdown("---")
st.caption("AdventureWorks Commercial Suite v2.6 • Absolute Syntax Stability Verified.")
